    ...
    return (
        <header className="bg-[#4C37C0] flex justify-between items-center p-4">
            ...
            <div className="links flex justify-center items-center gap-3 md:gap-5">
                <Link to={cartLink} className="flex flex-col items-center text-white text-xs md:text-sm whitespace-nowrap">
                    <img src={cart} alt="Carrito" className="w-[25px] md:w-[35px]" />
                    <span>Carrito</span>
                </Link>
                <Link to={accountLink} className="flex flex-col items-center text-white text-xs md:text-sm whitespace-nowrap">
